    ...
    return (
        <div className="recruiter-demo"> 
            <div className = "flex-container">
              <div className="flex-2-of-3">
                ...
                <div className="flex-1-of-3">
                    <img src={profile} alt='Fig Profile Demo' className="recruiter-demo--fig-img-2"/>
                </div>
            </div>

            <div className = "flex-container u-margin-top-huge">
                <div className="flex-1-of-3">
                    <img src={skills} alt='Fig Skill Demo' className="recruiter-demo--fig-img-2"/>
                </div>
            ...
            <div className = "flex-container u-margin-top-huge">
                ...
                <div className="flex-1-of-3">
                    <img src={personality} alt='Fig Personality Demo' className="recruiter-demo--fig-img-2"/>
                </div>
            </div>
        </div>
    );

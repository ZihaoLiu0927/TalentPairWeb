            ...
            <div className = "flex-container">
              <div className="flex-2-of-3">
                <div className="section-intro-text">
                    ...
                    <Link to="/auth/signin" className='section-intro--signlink'>Sign up today! &rarr; </Link>
                </div>
              </div>
            ...
            <div className = "flex-container u-margin-top-huge">
                ...
                <div className="flex-2-of-3">
                    <div className="section-intro-text">
                        ...
                        <Link to="/auth/signin" className='section-intro--signlink u-margin-left-huge'>Sign up for a free trial today &rarr; </Link>
                    </div>
                </div>
            </div>
        </div>
